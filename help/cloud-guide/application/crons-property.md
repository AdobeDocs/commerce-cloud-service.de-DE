...
- [Setzt hängengebliebene Cron-Aufträge manuell in der Cloud zurück](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/how-to/reset-stuck-magento-cron-jobs-manually-on-cloud.html)
