...
Die folgende Referenzdokumentation wird aus der `composer.lock` -Datei und deckt die erforderlichen Pakete ab, die in Adobe Commerce in Cloud Infrastructure 2.4.7 enthalten sind.

## Abhängigkeiten

`magento/magento-cloud-metapackage 2.4.7` hat die folgenden Abhängigkeiten:
...
<table>
  ...
  <tr>
    <td>
      <a href="https://github.com/FriendsOfPHP/proxy-manager-lts.git">friendlyPHP/proxy-manager-lts</a>
    </td>
    <td>Bibliothek</td>
  ...
  <tr>
    ...
    <td>Bibliothek</td>
    <td>Beleuchten Sie das Makro-Paket.</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    ...
    <td>Bibliothek</td>
    <td>Stellt Tools zur Internationalisierung Ihres Programms bereit</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    ...
    <td>Bibliothek</td>
    <td>Lädt YAML-Dateien und gibt sie aus</td>
  </tr>
  <tr>
    <td>
