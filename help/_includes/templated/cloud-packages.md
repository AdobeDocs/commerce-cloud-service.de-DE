...
Die folgende Referenzdokumentation wird aus der `composer.lock` generiert und behandelt die erforderlichen Pakete, die in Adobe Commerce in Cloud-Infrastruktur 2.4.7 enthalten sind.
